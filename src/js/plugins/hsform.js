(function($) {
  $.fn.hubspotForm = function(options) {
    var defaults = {
      portalID: "5341801",
      formGUID: "dc8268f9-a5c7-4ebc-b1e1-2c3ad9d956bc",
    ...
    var form = this;
    form.validate(settings.validationRules);
      ...
      if (form.valid()) {
        ...
        $.ajax({
          ...
          .fail(function(xhr) {
            ...
            messageBox.html("Something went wrong. Please try again later.");
          });
      }
    });
    return this;
